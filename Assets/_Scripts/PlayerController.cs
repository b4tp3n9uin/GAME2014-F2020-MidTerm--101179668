 ...
 * Program Description: Player Controlls and Movement Script.

 * Modifications: Changed player movement to move vertically and the check bounds function to make the player move vertically.
 */
